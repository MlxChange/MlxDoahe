...
public class DisArgeeAddFriendMessage extends BmobIMExtraMessage {
    ...
    public DisArgeeAddFriendMessage(){}

    /**
     * 继承BmobIMMessage的属性
     * @param msg
     */
    public DisArgeeAddFriendMessage(BmobIMMessage msg){
        super.parse(msg);
    }
     ...
     * @return
     */
    public static DisArgeeAddFriendMessage convert(BmobIMMessage msg){
        DisArgeeAddFriendMessage agree =new DisArgeeAddFriendMessage(msg);
        try {
